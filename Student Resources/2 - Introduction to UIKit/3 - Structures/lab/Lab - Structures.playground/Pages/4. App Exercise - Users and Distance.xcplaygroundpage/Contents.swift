 ...
 */
var kara = User(name: "Kara", age: 20, height: 68, weight: 145, activityLevel: 8)
print("User is named \(kara.name). \(kara.age) years old, \(kara.height) inches tall, \(kara.weight) pounds, and \(kara.activityLevel) on a scale of activity from 1 to 10.")
/*:
...
print("Distance in feet: \(mile.feet). Distance in inches: \(mile.inch)")
